        ...
        try {
            ...
            for (String cameraId : cameraManager.getCameraIdList()) {
                ...
                if (facing != null && facing == CameraCharacteristics.LENS_FACING_FRONT) {
                    ...
                    break; // Thoát sau khi xử lý camera trước
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
            Log.e(TAG, "Lỗi lấy thông tin camera: " + e.getMessage());
            Toast.makeText(requireContext(), "Lỗi khi lấy thông tin camera trước", Toast.LENGTH_SHORT).show();
        }
    }
}